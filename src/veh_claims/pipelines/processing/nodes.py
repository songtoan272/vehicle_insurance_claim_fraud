...
def encode_features(dataset: pd.DataFrame):
    ...
    col_ordering = [{'col': 'Month',
                    ...
                    {'col': 'VehiclePrice',
                     'mapping': {'more than 69000': 69001, '20000 to 29000': 24500, '30000 to 39000': 34500,
                                 'less than 20000': 19999,
                                 '40000 to 59000': 49500, '60000 to 69000': 64500}},
                    {'col': 'AgeOfVehicle',
                     'mapping': {'3 years': 3, '6 years': 6, '7 years': 7, 'more than 7': 8, '5 years': 5, 'new': 0,
                                 '4 years': 4, '2 years': 2}},
                    ...
                    {'col': 'Days_Policy_Accident',
                     'mapping': {'more than 30': 31, '15 to 30': 22.5, 'none': 0, '1 to 7': 4, '8 to 15': 11.5}},
                    {'col': 'Days_Policy_Claim',
                     'mapping': {'more than 30': 31, '15 to 30': 22.5, '8 to 15': 11.5, 'none': 0}},
                    {'col': 'AgeOfPolicyHolder',
                     'mapping': {'16 to 17': 16.5, '18 to 20': 19, '21 to 25': 23, '26 to 30': 28, '31 to 35': 33,
                                 '36 to 40': 38, '41 to 50': 45.5, '51 to 65': 58, 'over 65': 66}},
                    {'col': 'AddressChange_Claim',
                     'mapping': {'no change': 0, 'under 6 months': 0.5,
                                 '1 year': 1, '2 to 3 years': 2.5, '4 to 8 years': 6}},
                    {'col': 'NumberOfCars',
                     'mapping': {'1 vehicle': 1, '2 vehicles': 2, '3 to 4': 3.5, '5 to 8': 6.5, 'more than 8': 9}},
                    ]
    cols_ordinal = [x['col'] for x in col_ordering]
    cols_ordinal_float = ['Days_Policy_Accident', 'Days_Policy_Claim', 'AgeOfPolicyHolder', 'AddressChange_Claim', 'NumberOfCars']
    ...
    cols_onehot = ['Make', 'MaritalStatus', 'PolicyType', 'VehicleCategory', 'BasePolicy']
    one_hot_encoder = OneHotEncoder(cols=cols_onehot, use_cat_names=True, return_df=True)
